...
export const ChatHeader = () => {
  ...
  return (
    <div className="h-16 border-b border-[#334155] bg-[#0F172A]/95 backdrop-blur sticky top-0 z-10 flex items-center px-4 md:px-6">
      <div className="flex items-center gap-3">
        <button 
          onClick={toggleSidebar}
          className="p-2 -ml-2 text-[#94A3B8] hover:text-[#F8FAFC] hover:bg-[#1E293B] rounded-lg transition-colors"
